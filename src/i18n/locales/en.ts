...
export const en: TranslationDictionary = {
    ...
    googleCloudSpeechCredentialFormat: ({ provider }) =>
      `${provider} STT needs Google Cloud Speech credentials in the format <project-id>|<access-token>|<location>, or the combined Gemini format AIza...|<project-id>|<access-token>|<location>.`,
