...
export const PROVIDER_PREVIEW_SAMPLE_TEXT_BY_LANGUAGE: Record<
  ...
  string
> = {
  en: "Hello. This is a longer voice preview for Schnack, spoken at a calm and steady pace so you can judge clarity, tone, and whether this voice feels pleasant enough for full replies. If you listen for a few seconds, you should get a realistic sense of how this provider voice will sound during everyday conversations.",
  de: "Hallo. Dies ist eine laengere Stimmprobe fuer Schnack, damit du hoeren kannst, wie klar die Aussprache ist und ob die Stimme auch ueber mehrere Saetze hinweg angenehm klingt. Wenn sie hier ruhig und natuerlich wirkt, passt sie in der Regel auch gut fuer laengere Antworten im Alltag.",
...
export const LOCAL_PREVIEW_SAMPLE_TEXT_BY_LANGUAGE: Record<
  ...
  string
> = {
  en: "Hello. This is a longer local voice preview for Schnack, spoken slowly enough that you can hear how clear the pronunciation is and whether the rhythm feels natural for a full conversation. If this voice sounds pleasant over these two sentences, it will usually also feel comfortable when the app reads longer replies aloud.",
  de: "Hallo. Dies ist eine längere lokale Stimmprobe für Schnack, damit du hören kannst, wie klar die Aussprache ist und ob die Stimme auch über mehrere Sätze hinweg angenehm klingt. Wenn sich diese Stimme hier ruhig und natürlich anhört, passt sie in der Regel auch gut für längere Antworten im Alltag.",
