...
class ColumboNativeAudioQueueModule(
  reactContext: ReactApplicationContext,
) : ReactContextBaseJavaModule(reactContext) {
  companion object {
    const val NAME = "ColumboNativeAudioQueue"
    private const val EVENT_NAME = "ColumboNativeAudioQueueEvent"
  }

  private val coordinator = ColumboAudioQueueCoordinator(
  ...
  private fun emitQueueEvent(event: ColumboAudioQueueEvent) {
